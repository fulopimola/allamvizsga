...
public class ProductJdbcDAO implements ProductDAO {
	...
	@Override
	public double getProductPriceInShop(int productId, int shopId) throws SQLException, DAOException {
		// TODO Auto-generated method stub
		String command = "SELECT `Price` FROM `productsinshop` WHERE `Products_ProductId` = ? AND `Shops_ShopId` = ?";
		PreparedStatement statement;
